...
Various features may generate files for support purposes. For example HTTP requests that take more than 10 seconds are
recorded as Slow Requests in a file under `$JENKINS_HOME/slow-requests`. The content generated by those contributors
can be managed (downloaded / deleted) from the GUI at **Support > Manage Generated Content**

![](docs/images/support_content_page.png)
