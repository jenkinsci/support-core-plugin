...
public class ProxyConfigurationTest {
    ...
    @Test
    @Issue({"JENKINS-68008", "JENKINS-73599"})
    public void testProxyContent() {
        ...
        String ucMdToString =
                SupportTestUtils.invokeComponentToString(Objects.requireNonNull(ExtensionList.lookup(Component.class)
                        .get(com.cloudbees.jenkins.support.impl.ProxyConfiguration.class)));
